...
# Modified by Dequan Wang, Xingyi Zhou, Zhen Dong
# ------------------------------------------------------------------------------
...
class BaseNode(nn.Module):
    def __init__(self, inp, oup, stride, conv_kernel, batch_norm=nn.BatchNorm2d):
...
class PoseResNet(nn.Module):
    ...
    ## This _make_layer is for original resnet backbone
    ...
    #     self.inplanes = planes * block.expansion
    #     for i in range(1, blocks):
    #         layers.append(BaseNode(self.inplanes, planes, 1, nn.Conv2d))
    #
    #     return nn.Sequential(*layers)
...
def get_pose_net(num_layers, heads, head_conv=256, deform_conv='ModulatedDeformConvPack'):
